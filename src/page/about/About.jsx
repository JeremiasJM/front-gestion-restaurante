      ...
      <div className="App">
        <div className="contenedor-principal">
          ...
          <CardAbout
            ...
            email={
              <a href="mailto:andijoorlandi@gmail.com">
                <FaEnvelope />
              </a>
            }
            linkedIn={
          ...
          <CardAbout
            ...
            email={
              <a href="mailto:jeremiasjuarezmarrades15@gmail.com">
                <FaEnvelope />
              </a>
            }
            linkedIn={
              <a
                href="https://www.linkedin.com/in/jeremiasjm/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaLinkedinIn />
          ...
          <CardAbout
            ...
            email={
              <a href="mailto:braianmena@gmail.com">
                <FaEnvelope />
              </a>
            }
            linkedIn={
              <a
                href="https://www.linkedin.com/in/braian-mena"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaLinkedinIn />
          ...
          <CardAbout
            ...
            email={
              <a href="mailto:fernandezcristian.utn@gmail.com">
                <FaEnvelope />
              </a>
            }
            linkedIn={
              <a
                href="https://www.linkedin.com/in/fern%C3%A1ndez-cristian-javier-93-/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaLinkedinIn />
