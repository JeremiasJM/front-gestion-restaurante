  ...
  return (
    <>
      <section  className="container  mt-5 mb-5">
        <h2 className="text-center pt-5 ">Un Poco de Nosotros</h2>
        <article className="container text-center mt-4">
          <div className="grid-gallery">
            <a className="grid-gallery__item">
              <img
            ...
            <a className="grid-gallery__item">
              <img
                className="grid-gallery__image scrollFadeAnimation"
                src="https://images.pexels.com/photos/2233351/pexels-photo-2233351.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="ImagenGaleria5"
              />
            </a>
            <a className="grid-gallery__item">
            ...
            <a className="grid-gallery__item d-none d-md-block">
              <img
                className="grid-gallery__image scrollFadeAnimation"
            ...
            <a className="grid-gallery__item">
              <img
                className="grid-gallery__image d-none d-md-block scrollFadeAnimation"
                src="https://images.pexels.com/photos/4691211/pexels-photo-4691211.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="ImagenGaleria9"
              />
            </a>
            <a className="grid-gallery__item">
            ...
            <a className="grid-gallery__item">
              <img
                className="grid-gallery__image d-none d-md-block scrollFadeAnimation"
                src="https://images.pexels.com/photos/1474930/pexels-photo-1474930.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="ImagenGaleria9"
              />
            </a>
            <a className="grid-gallery__item">
